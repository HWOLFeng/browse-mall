 ...
 */
@Repository
public interface SimpleShoesMapper extends SuperMapper<SimpleShoes> {
    /**
     * 分页，批量选择数据
     ...
     */
    @Override
    List<SimpleShoes> selectListByLogic(Pagination page, @Param("isDeleted") Integer isDeleted);
}
